export default {
    ...
    folderExists:
        'A :attribute with this name already exists. Please choose a different name.',
    fileExists:
        'A file with this name already exists in this folder. Rename the file before uploading.',
}
